...
curl https://raw.githubusercontent.com/anzclan/MULTIPORT/main/LITE/NGINX/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/anzclan/MULTIPORT/main/LITE/NGINX/vps.conf > /etc/nginx/conf.d/vps.conf
