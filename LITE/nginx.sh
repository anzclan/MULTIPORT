...
curl https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/ssh/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/fisabiliyusri/Mantap/main/ssh/vps.conf > /etc/nginx/conf.d/vps.conf
